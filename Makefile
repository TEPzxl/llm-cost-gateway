.PHONY: up down migrate-up migrate-down verify-migration verify-alert-rules seed-demo smoke-test load-test backup-demo restore-drill sqlc-generate test run secret-rotate console-install console-build
